...
interface ModalPrivetOfficeProps {
    ...
    isSpecial?: boolean;  // Новый проп для специального места (по умолчанию false)
}
...
const ModalPrivetOffice: React.FC<ModalPrivetOfficeProps> = ({ setNewState, isSpecial = false }) => {
